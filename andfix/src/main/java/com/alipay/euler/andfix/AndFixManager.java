...
public class AndFixManager {
	...
	public AndFixManager(Context context) {
		mContext = context;
		try {
			Class<?> clzz = ArtMethodSize.class; //context.getClassLoader().loadClass("com.alipay.euler.andfix.ArtMethodSize");
			Method fun1 = clzz.getDeclaredMethod("fun1", null);
			Method fun2 = clzz.getDeclaredMethod("fun2", null);

			AndFix.initArtMethodSize(fun1, fun2);
